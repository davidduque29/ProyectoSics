...
<html>
    <head>
        ...
        <title>fase2-DisenoWeb-Logo</title>
        <!-- LINKS -->
    ...
    <body>
        ...
        <section class="row container-fluid text-center fondo_mate">       
            <div class="col-sx-12 col-sm-12 col-md-12 col-lg-12">	
                <h1 class="text-header-g">LOGOTIPO</h1>
            </div>
        </section>
        ...
        <section class="row fondo_mate center-block">       
            ...
            <div class="col-sx-10 col-sm-10 col-md-10 col-lg-10">
                <img src="../resources/docs/DiseñoWeb/LOGO/isotipo_ficha.jpg" class="img-dw" alt="logo">
                <p>
                    <a href="../resources/docs/DiseñoWeb/LOGO/isotipo_ficha.pdf" download="isotipo_ficha.pdf" class="btn btn-info btn-md">
        ...
        <section class="row fondo_mate">       
            <div class="col-sx-12 col-sm-12 col-md-12 col-lg-12 container-fluid">	

                <div class="col-sx-4 col-sm-4 col-md-4 col-lg-4">
                    <img src="../resources/docs/DiseñoWeb/LOGO/isotipo_color.jpg" class="img-dw" alt="">
                    <p>
                        <a href="../resources/docs/DiseñoWeb/LOGO/isotipo_color.pdf" download="isotipo_color.pdf" class="btn btn-info btn-md">
                            <span class="glyphicon glyphicon-download-alt">	    </span> 		
                        </a>
                    </p>
                </div>
                ...
                <div class="col-sx-4 col-sm-4 col-md-4 col-lg-4">
                    <img src="../resources/docs/DiseñoWeb/LOGO/isotipo_negro.jpg" class="img-dw" alt="">

                    <p>
                        <a href="../resources/docs/DiseñoWeb/LOGO/isotipo_negro.pdf" download="isotipo_negro.pdf" class="btn btn-info btn-md">
                            <span class="glyphicon glyphicon-download-alt">	    </span> 		
                        </a>
                    </p>
                </div>
