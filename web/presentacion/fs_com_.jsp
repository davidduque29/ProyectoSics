<%-- 
    Document   : fs_com_
    Created on : 16-jun-2017, 9:28:29
    Author     : ivandavid
--%>
...
<html>
    <head>
        ...
        <meta charset="UTF-8">
        <title>Fase2-Comunicacion</title>
            ...
            <div class="col-sx-12 col-sm-12 col-md-12 col-lg-12">		
                ...
                <section class="row container-fluid text-center">       
                    <div class="col-sx-12 col-sm-12 col-md-12 col-lg-12 text-center">	
                        <h1 class="text-header-g">Documento proyecto Sics</h1>
                    </div>
                </section>
                ...
                <section class="row">       
                    ...
                    <div class="col-sx-6 col-sm-6 col-md-6 col-lg-6">
                        ...
                        <iframe src="../resources/docs/Comunicacion/ProyectoQuala.pdf" style="width:100%; height:450px;" frameborder="0" allowfullscreen></iframe>
                    </div>
                ...
                <section class="row pull-right">
                    ...
                    <div class="col-sx-11 col-sm-11 col-md-11 col-lg-11 pull-right">
                        ...
                        <p><!-- ((((.. boton Descarga ..)))) -->				
                            <a href="../resources/docs/Comunicacion/ProyectoQuala.pdf" download="ProyectoQuala.pdf" class="btn btn-info btn-md">
